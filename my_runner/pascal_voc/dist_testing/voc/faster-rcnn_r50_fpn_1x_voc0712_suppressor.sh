...
CONFIG='my_configs/pascal_voc/faster-rcnn_r50_fpn_1x_voc0712_suppressor.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/od/voc/fasterRCNN_r50_fpn_1x_suppressor/epoch_4.pth'
BASE_WORK_DIR='local_results/od/voc/fasterRCNN_r50_fpn_1x_suppressor/'
