...
GPUS_ids="2,3,4,5"
CHECKPOINT='local_results/od/coco/retinanet_r50_fpn_1x_coco_suppressor/epoch_12.pth'
BASE_WORK_DIR='local_results/od/coco/retinanet_r50_fpn_1x_coco_suppressor'
