...
CONFIG='my_configs/coco/mask-rcnn_r50_fpn_1x_coco.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/od/coco/maskRCNN_r50_fpn_1x_original/epoch_12.pth'
BASE_WORK_DIR='local_results/od/coco/maskRCNN_r50_fpn_1x_original'
