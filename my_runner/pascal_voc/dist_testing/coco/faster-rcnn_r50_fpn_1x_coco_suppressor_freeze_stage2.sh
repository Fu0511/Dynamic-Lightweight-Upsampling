...
CONFIG='my_configs/coco/faster-rcnn_r50_fpn_1x_coco_suppressor_freeze_stage2.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/od/coco/fasterRCNN_r50_fpn_1x_suppressor_freeze_stage2/epoch_12.pth'
BASE_WORK_DIR='local_results/od/coco/fasterRCNN_r50_fpn_1x_suppressor_freeze_stage2'
