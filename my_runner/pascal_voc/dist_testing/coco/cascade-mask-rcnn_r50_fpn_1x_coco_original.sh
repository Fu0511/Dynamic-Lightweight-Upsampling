...
CONFIG='my_configs/coco/cascade-mask-rcnn_r50_fpn_1x_coco_original.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="2,3,4,5"
CHECKPOINT='local_results/od/coco/cascade-mask-rcnn_r50_fpn_1x_coco_original/epoch_12.pth'
BASE_WORK_DIR='local_results/od/coco/cascade-mask-rcnn_r50_fpn_1x_coco_original'
